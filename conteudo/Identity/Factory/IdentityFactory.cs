...
namespace AngularCBFBackEND.Identity.Factory
{
    public class IdentityFactory
    {
        ...
        {
            var usuarioExistente = await IdentityController._gerenciarUsuario.FindByEmailAsync(model.Senha);
        ...
        public static async Task<bool> CriarNovoUsuario([FromBody] IdentityRegistroModel model)
        {
            ...
            var resultado = await IdentityController._gerenciarUsuario.CreateAsync(usuario, model.Senha);
